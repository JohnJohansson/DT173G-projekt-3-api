...
switch ($method) {
    ...
    case 'POST':
        ...
        if ($school->addWebbpage($table, $data->kurskod, $data->kursnamn, $data->progression, $data->kursplan)) {
    ...
    case 'PUT':
        ...
        if (!isset($id)) {
            ...
            if ($school->updateWebbpage($table, $id, $data->kurskod, $data->kursnamn, $data->progression, $data->kursplan)) {
                http_response_code(200);
