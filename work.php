...
switch ($method) {
    ...
    case 'POST':
        ...
        if ($school->addWork($table, $data->kurskod, $data->kursnamn, $data->progression, $data->kursplan)) {
    ...
    case 'PUT':
        ...
        if (!isset($id)) {
            ...
            if ($school->updateWork($table, $id, $data->kurskod, $data->kursnamn, $data->progression, $data->kursplan)) {
                http_response_code(200);
